...
func (m *Role) Pagination(offset int, limit int, key string) (res []Role, count int64) {
	query := Db
	if key != "" {
...
func (m *Role) FindByMap(offset int, limit int, dataMap map[string]interface{},orderBy string) (res []Role, total int64, err error) {
	query := Db
