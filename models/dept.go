...
func (m *Dept) Pagination(offset int, limit int, key string) (res []Dept, count int64) {
	query := Db
	if key != "" {
...
func (m *Dept) FindByMap(offset int, limit int, dataMap map[string]interface{},orderBy string) (res []Dept, total int64, err error) {
	query := Db
